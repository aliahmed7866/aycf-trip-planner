...
FALLBACK_IATA = {
    ...
    "leeds/bradford": "LBA", "lisbon": "LIS", "liverpool": "LPL", "ljubljana": "LJU",
    "lodz": "LCJ", "london": "LTN", "london luton": "LTN", "london gatwick": "LGW",
    "london stansted": "STN", "gatwick": "LGW", "luton": "LTN", "stansted": "STN",
    "lyon": "LYS", "madrid": "MAD", "malaga": "AGP", "malmo": "MMX", "malta": "MLA",
    "marrakech": "RAK", "marrakesh": "RAK", "memmingen": "FMM", "milan": "MXP",
    "milan malpensa": "MXP", "munich": "MUC", "naples": "NAP", "nice": "NCE",
    "nuremberg": "NUE", "oslo": "OSL", "oslo torp": "TRF", "palermo": "PMO",
    "paphos": "PFO", "paris": "BVA", "paris beauvais": "BVA", "pisa": "PSA",
    "podgorica": "TGD", "porto": "OPO", "poznan": "POZ", "prague": "PRG",
    "pristina": "PRN", "reykjavik": "KEF", "reykjavik keflavik": "KEF", "rhodes": "RHO",
    "riga": "RIX", "rome": "FCO", "rome fiumicino": "FCO", "rzeszow": "RZE",
...
def _load_public_wizz_map(client) -> int:
    ...
    session.headers.update({"User-Agent": os.environ.get("WIZZ_USER_AGENT", "Mozilla/5.0 (Linux; Android 14) AppleWebKit/537.36 Chrome/124 Safari/537.36"), "Accept": "application/json,text/plain,*/*", "Origin": "https://www.wizzair.com", "Referer": "https://www.wizzair.com/"})
    try:
    ...
    for version in candidates:
        for path in ("Api/asset/MapData", "Api/asset/map"):
            try:
                response = session.get(f"https://be.wizzair.com/{version}/{path}?languageCode=en-gb", timeout=20)
    ...
    if payload:
        for city in payload.get("cities") or []:
            ...
            for key in ("name", "shortName", "city", "cityName", "airportName", "displayName", "nameWithCountry", "fullName"):
...
def prepare_required_stations(client, required_names: Iterable[str]) -> dict:
    ...
    for name in required:
        ...
        if code:
            ...
            resolved += 1
    return {"required": len(required), "resolved": resolved, "unresolved": unresolved, "normalized_added": normalized_added, "public_added": public_added, "aliases": len(client.station_ids)}
